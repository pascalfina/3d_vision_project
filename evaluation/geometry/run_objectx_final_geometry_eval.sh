...
GT_MESH="${GT_MESH:-${BASELINE_ROOT:+$BASELINE_ROOT/scenes/$SCAN_ID/mesh.refined.v2.obj}}"
GT_SEQUENCE_ZIP="${GT_SEQUENCE_ZIP:-${BASELINE_ROOT:+$BASELINE_ROOT/scenes/$SCAN_ID/sequence.zip}}"
