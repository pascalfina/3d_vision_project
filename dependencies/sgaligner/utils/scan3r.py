...
def load_ply_data(data_dir, scan_id, label_file_name, matrix=None):
...
def create_ply_data(ply_data, visible_pts_idx=None):
    if visible_pts_idx is None:
        visible_pts_idx = np.arange(len(ply_data['vertex']['x']))
